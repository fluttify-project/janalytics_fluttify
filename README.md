...
# 极光 统计组件 Flutter插件
[![pub package](https://img.shields.io/pub/v/janalytics_fluttify.svg)](https://pub.Flutter-io.cn/packages/janalytics_fluttify)
...
## 使用
参考[wiki](https://github.com/fluttify-project/janalytics_fluttify/wiki).
