...
class cn_jiguang_analytics_android_api_aop_JFragActAx extends java_lang_Object  {
  ...
  Future<void> onContentChanged() async {
    ...
    final __result__ = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.aop.JFragActAx::onContentChanged', {"refId": refId});
...
extension cn_jiguang_analytics_android_api_aop_JFragActAx_Batch on List<cn_jiguang_analytics_android_api_aop_JFragActAx> {
  ...
  Future<List<void>> onContentChanged_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.aop.JFragActAx::onContentChanged_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
