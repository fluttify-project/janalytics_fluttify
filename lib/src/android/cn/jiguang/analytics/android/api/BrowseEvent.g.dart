...
class cn_jiguang_analytics_android_api_BrowseEvent extends cn_jiguang_analytics_android_api_Event with java_io_Serializable {
  ...
  static Future<cn_jiguang_analytics_android_api_BrowseEvent> create__String__String__String__float(String var1, String var2, String var3, double var4) async {
    ...
    final object = cn_jiguang_analytics_android_api_BrowseEvent()..refId = refId..tag = 'janalytics_fluttify';
  ...
  Future<String> getBrowseId() async {
    ...
    if (fluttifyLogEnabled) {
      print('fluttify-dart: cn.jiguang.analytics.android.api.BrowseEvent@$refId::getBrowseId([])');
    }
  
    // invoke native method
    final result = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.BrowseEvent::getBrowseId', {"refId": refId});
  ...
  Future<cn_jiguang_analytics_android_api_BrowseEvent> setBrowseId(String var1) async {
    // print log
    if (fluttifyLogEnabled) {
      print('fluttify-dart: cn.jiguang.analytics.android.api.BrowseEvent@$refId::setBrowseId([\'var1\':$var1])');
    }
  
    // invoke native method
    final result = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.BrowseEvent::setBrowseId', {"var1": var1, "refId": refId});
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(cn_jiguang_analytics_android_api_BrowseEvent()..refId = result..tag = 'janalytics_fluttify');
      return cn_jiguang_analytics_android_api_BrowseEvent()..refId = result..tag = 'janalytics_fluttify';
    }
  }
  ...
  Future<String> getBrowseName() async {
    // print log
    if (fluttifyLogEnabled) {
      print('fluttify-dart: cn.jiguang.analytics.android.api.BrowseEvent@$refId::getBrowseName([])');
    }
  
    // invoke native method
    final result = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.BrowseEvent::getBrowseName', {"refId": refId});
  ...
  Future<cn_jiguang_analytics_android_api_BrowseEvent> setBrowseName(String var1) async {
    // print log
    if (fluttifyLogEnabled) {
      print('fluttify-dart: cn.jiguang.analytics.android.api.BrowseEvent@$refId::setBrowseName([\'var1\':$var1])');
    }
  
    // invoke native method
    final result = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.BrowseEvent::setBrowseName', {"var1": var1, "refId": refId});
  ...
  Future<String> getBrowseType() async {
    // print log
    if (fluttifyLogEnabled) {
      print('fluttify-dart: cn.jiguang.analytics.android.api.BrowseEvent@$refId::getBrowseType([])');
    }
  
    // invoke native method
    final result = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.BrowseEvent::getBrowseType', {"refId": refId});
  ...
  Future<cn_jiguang_analytics_android_api_BrowseEvent> setBrowseType(String var1) async {
    // print log
    if (fluttifyLogEnabled) {
      print('fluttify-dart: cn.jiguang.analytics.android.api.BrowseEvent@$refId::setBrowseType([\'var1\':$var1])');
    }
  
    // invoke native method
    final result = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.BrowseEvent::setBrowseType', {"var1": var1, "refId": refId});
  ...
  Future<double> getBrowseDuration() async {
    // print log
    if (fluttifyLogEnabled) {
      print('fluttify-dart: cn.jiguang.analytics.android.api.BrowseEvent@$refId::getBrowseDuration([])');
    }
  
    // invoke native method
    final result = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.BrowseEvent::getBrowseDuration', {"refId": refId});
  ...
  Future<cn_jiguang_analytics_android_api_BrowseEvent> setBrowseDuration(double var1) async {
    // print log
    if (fluttifyLogEnabled) {
      print('fluttify-dart: cn.jiguang.analytics.android.api.BrowseEvent@$refId::setBrowseDuration([\'var1\':$var1])');
    }
  
    // invoke native method
    final result = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.BrowseEvent::setBrowseDuration', {"var1": var1, "refId": refId});
...
extension cn_jiguang_analytics_android_api_BrowseEvent_Batch on List<cn_jiguang_analytics_android_api_BrowseEvent> {
  ...
  Future<List<cn_jiguang_analytics_android_api_BrowseEvent>> setBrowseId_batch(List<String> var1) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((result) => cn_jiguang_analytics_android_api_BrowseEvent()..refId = result..tag = 'janalytics_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
