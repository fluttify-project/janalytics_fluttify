...
class cn_jiguang_analytics_android_api_RegisterEvent extends cn_jiguang_analytics_android_api_Event with java_io_Serializable {
  ...
  static Future<List<cn_jiguang_analytics_android_api_RegisterEvent>> create_batch__String__boolean(List<String> var1, List<bool> var2) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('ObjectFactory::create_batchcn_jiguang_analytics_android_api_RegisterEvent__String__boolean', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__], "var2": var2[__i__]}]);
  ...
  Future<String> getRegisterMthod() async {
    ...
    final __result__ = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.RegisterEvent::getRegisterMthod', {"refId": refId});
  ...
  Future<cn_jiguang_analytics_android_api_RegisterEvent> setRegisterMethod(String var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.RegisterEvent::setRegisterMethod', {"var1": var1, "refId": refId});
  ...
  Future<bool> getRegisterSuccess() async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.RegisterEvent::getRegisterSuccess', {"refId": refId});
  ...
  Future<cn_jiguang_analytics_android_api_RegisterEvent> setRegisterSuccess(bool var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.RegisterEvent::setRegisterSuccess', {"var1": var1, "refId": refId});
...
extension cn_jiguang_analytics_android_api_RegisterEvent_Batch on List<cn_jiguang_analytics_android_api_RegisterEvent> {
  ...
  Future<List<String>> getRegisterMthod_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.RegisterEvent::getRegisterMthod_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
  ...
  Future<List<cn_jiguang_analytics_android_api_RegisterEvent>> setRegisterMethod_batch(List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.RegisterEvent::setRegisterMethod_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "refId": this[__i__].refId}]);
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<int>().map((__result__) => cn_jiguang_analytics_android_api_RegisterEvent()..refId = __result__..tag__ = 'janalytics_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
  ...
  Future<List<bool>> getRegisterSuccess_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.RegisterEvent::getRegisterSuccess_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
  ...
  Future<List<cn_jiguang_analytics_android_api_RegisterEvent>> setRegisterSuccess_batch(List<bool> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/janalytics_fluttify').invokeMethod('cn.jiguang.analytics.android.api.RegisterEvent::setRegisterSuccess_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "refId": this[__i__].refId}]);
